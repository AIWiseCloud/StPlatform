    ...
    >
      ...
      >
        ...
        <el-form-item label="联系人" prop="contacter">
          <el-input v-model="shopData.contacter"></el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="phoneNumber">
          <el-input v-model="shopData.phoneNumber"></el-input>
        </el-form-item>
        <el-form-item label="店铺简介" prop="introduction">
          <el-input v-model="shopData.introduction"></el-input>
        </el-form-item>
        <el-form-item label="店铺公告" prop="announcement">
          <el-input v-model="shopData.announcement"></el-input>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    openDialog(isAdd, index, row) {
      ...
      if (isAdd) {
        ...
        let copyData = JSON.stringify(row);
      ...
      this.$refs[formname].validate((valid) => {
        if (valid) {
          apiSettings
            ...
            .catch((err) => {
              console.log("手机号为空", JSON.stringify(this.shopData));
