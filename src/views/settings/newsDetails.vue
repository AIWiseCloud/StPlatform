          ...
          <el-row class="row1">
            <el-col :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="编号" prop="newsId">
                <el-input v-model="newsData.newsId" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="24" :md="8" :lg="8" :xl="8">
          ...
          <el-row class="row2">
            ...
            <el-col :sm="8" :md="8" :lg="8" :xl="8">
              <el-form-item label="排序">
                <el-input v-model="newsData.fIndex"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row class="row3">
            <el-col :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="状态">
                <el-input v-model="statusName" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="阅读量">
                <el-input v-model="newsData.amountReading" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="点赞数">
                <el-input v-model="newsData.numberLike" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-col>
